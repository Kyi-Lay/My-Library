let questions = [
    {
      question: "What will happen if the user inputs the number 15?",
      options: ["(A) Got it!", "(B) Less than.", "(C) Greater than", "(D) None of.", "(E) Invalid input"],
      answer: "(B) Less than.",
    },
    {
      question: "What type of loop is used in the code to iterate over the students array?",
      options: ["(A) while loop", "(B) for loop", "(C) do-while loop", "(D) foreach loop"],
      answer: "(B) for loop",
    },
    {
      question: "What does the === operator check for in JavaScript?",
      options: ["(A) Only value equality", "(B) Only type equality", "(C) Both value and type equality", "(D) None of the above", "(E) They are equal in type and value "],
      answer: "(C) Both value and type equality ",
    },
    {
      question: "What will be the output of the function?",
      options: ["(A) shout,shout", "(B) Shout,Shout", "(C) shout it all out!", "(D) shout, it all out!", "(E) Just shout"],
